 ...
 */
public abstract class CommonRecycleViewAdapter<T> extends
		RecyclerView.Adapter<ViewHolderHelper> implements DataIO<T> {
	...
	public ViewHolderHelper onCreateViewHolder(final ViewGroup parent, int viewType) {
		...
		if (mAnimator != null)
			mAnimator.onSpringItemCreate(viewHolder.itemView);
		return viewHolder;
	}
