...
public class NewBanner
    ...
    private BannerDoubleClickListener mDoubleClickListener;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context)
                .inflate(R.layout.banner, this, true);
    ...
    private void setTitleStyleUI() {
        ...
        if (titleHeight != -1) {
            titleView.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    titleHeight));
        }
        if (titleTextColor != -1) {
                            ...
                            if (clickcount == 1) {
                                ...
                                if (lastClick - firstClick < 300) {// 判断是否是执行了双击事件
                                    ...
                                    if (mDoubleClickListener!=null){
                                        mDoubleClickListener.onBannerDoubleClick();
                                    }
                                }
                            }
                            break;
            ...
            if (bannerListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Log.e(tag,
                                "你正在使用旧版点击事件接口，下标是从1开始，" + "为了体验请更换为setOnBannerListener，下标从0开始计算");
    ...
    public interface BannerDoubleClickListener {
        void onBannerDoubleClick();
    }

    public void setOnBannerDoubleClickListener(BannerDoubleClickListener listener) {
