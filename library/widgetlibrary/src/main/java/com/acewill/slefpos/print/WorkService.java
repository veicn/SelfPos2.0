...
public class WorkService extends Service {
	...
	public static  PrinterThread workThread     = null;
	...
	public void onCreate() {
		...
		workThread = new PrinterThread(mHandler);
		workThread.start();
		Log.v("WorkService", "onCreate");
		FileLog.log("log", WorkService.class, "oncreate", "create", "success");
	}
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		notifyHandlers(msg);
//		FileLog.log("log", WorkService.class, "onStartCommand", "onStartCommand", "success");
