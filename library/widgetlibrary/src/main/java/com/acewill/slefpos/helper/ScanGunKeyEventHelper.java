package com.acewill.slefpos.helper;
...
public class ScanGunKeyEventHelper {
	...
	private void performScanSuccess() {
		...
		FileLog
				.log(Common.Log, ScanGunKeyEventHelper.class, "performScanSuccess", "LOG", barcode);
		if (mOnScanSuccessListener != null)
			mOnScanSuccessListener.onUsbScanSuccess(barcode);
	...
	public void analysisKeyEvent(KeyEvent event) {
		...
		if (event.getAction() == KeyEvent.ACTION_DOWN) {
			...
			if (keyCode == KeyEvent.KEYCODE_ENTER) {
				//				FileLog
				//						.log(Common.Log, NewMainFragment.class, "performScanSuccess", "LOG", "keyCode == KeyEvent.KEYCODE_ENTER");
				//若为回车键，直接返回
	...
	public interface OnScanSuccessListener {
		void onUsbScanSuccess(String barcode);
	}
