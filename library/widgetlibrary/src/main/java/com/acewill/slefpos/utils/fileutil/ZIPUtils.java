...
public class ZIPUtils {
     ...
     * @param zipFileString  label of ZIP
     * @param outPathString   path to be unZIP
     * @throws Exception
     */
    public static void UnZipFolder(String zipFileString, String outPathString) throws Exception {
    	File file2 = new File(outPathString);
    	if(!file2.exists()){
    		file2.mkdirs();
    	}
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {
            ...
            if (zipEntry.isDirectory()) {
                // get the folder label of the widget
     ...
     * @param zipFileString   the path label of result ZIP
     * @throws Exception
     */
     ...
     * @param zipFileString  label of ZIP 
     * @param fileString     label of file in the ZIP 
     * @return InputStream 
     * @throws Exception 
     */  
