package com.acewill.slefpos.utils.scanutils;
...
public class QRCodeScanUtil {
	...
	private static       int  baud        = 115200;// 9600;//115200 /* baud rate */
			...
			switch (msg.what) {
				case REV_DATA:
					...
					synchronized (QRCodeScanUtil.this) {
						...
						//						FileLog.printResult((String) msg.obj, "scan");
					}
					break;
	...
	private QRCodeScanUtil(Context context) {
		...
		d2xxListener = null;
		openIndex = SPUtils.getSharedIntData(context, "QRINIT");
		FileLog.log("openIndex:" + openIndex);
		connectFunction();
	}
