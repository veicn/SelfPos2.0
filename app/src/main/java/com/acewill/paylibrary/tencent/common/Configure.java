...
public class Configure {
	...
	// 以下是几个API的路径：
	// 1）被扫支付API(刷卡支付)
	public static String MICRO_PAY_API = "https://api.mch.weixin.qq.com/pay/micropay";
	// 1）扫码支付API
	...
	public static String HttpsRequestClassName = "com.acewill.paylibrary.tencent.common.HttpsRequest";
