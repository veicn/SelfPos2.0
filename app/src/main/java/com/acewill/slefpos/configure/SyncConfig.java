...
public class SyncConfig {
	...
	public static final String CONSUMERKEY = "2FMf6HR9RDOCN0tL7QHJag";
	//	public static final String CONSUMERKEY = "DEOI6Ff3QFmXL0A2oOVv0g";
	public static final String SIGNMODEL   = "DEBUG";
	//测试环境
