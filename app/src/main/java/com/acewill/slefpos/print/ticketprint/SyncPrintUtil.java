...
//
//
//			spaceNum = leftSpace2 - headNameLength;
//			gap = 0;
//			if (spaceNum > 0) {
...
//			}
//
//			sb.append(dishModel.getPrice());
//			int priceHeaderLength = calculateHeadNameLength(dishModel.getPrice());
//			spaceNum = leftSpace - priceHeaderLength;
//			for (int i = 0; i < spaceNum + 1; i++) {//数量的数字往后移了一位
//				sb.append(" ");
//			}
//			sb.append(dishModel.getQuantity());
//			if (gap == 0) {
//				spaceNum = rightSpace - leftSpace - String
//						.valueOf(dishModel.getQuantity())
//						.length() - 5;//减1 是因为数量的数字往后移了一位
//			} else {
//				spaceNum = rightSpace - leftSpace - String
//						.valueOf(dishModel.getQuantity())
//						.length() - gap;
...
//					int spaceNum2       = leftSpace - headNameLength2;
//					for (int i = 0; i < spaceNum2 - 3; i++) {
//						sb.append(" ");
//					}
//					sb.append("x" + packageBean.getQuantity());
//					sb.append("\n");
...
//		spaceNum = leftSpace - headNameLength;
//		int gap = 0;
//		if (spaceNum > 0) {
...
//		int           spaceNum = 0;
//		sb.append(headName);
//		spaceNum = rightSpace - headName.length() * 2;
//		for (int i = 0; i < spaceNum; i++) {
//			sb.append(" ");
//		}
...
//			}
//		}
//		WshAccount account = SmarantDataProvider.getWshAccount();
//
